...
![CodeQL](https://github.com/hishprorg/reiciendis-modi/workflows/CodeQL/badge.svg)
![CI test](https://github.com/hishprorg/reiciendis-modi/workflows/ci-test/badge.svg)
[![Coverage Status](https://img.shields.io/coveralls/github/hishprorg/reiciendis-modi)](https://coveralls.io/github/hishprorg/reiciendis-modi?branch=main)
...
```bash
npm i @hishprorg/reiciendis-modi
```

```ts
import { extract } from '@hishprorg/reiciendis-modi'
...
```ts
import { extract } from 'npm:@hishprorg/reiciendis-modi'
```

### Browser

```ts
import { extract } from 'https://esm.sh/@hishprorg/reiciendis-modi'
```

Please check [the examples](https://github.com/hishprorg/reiciendis-modi/tree/main/examples) for reference.
...
CJS is deprecated for this package.  When calling `require('@hishprorg/reiciendis-modi')` a deprecation warning is now logged.  You should update your code to use the ESM export.
...
Passing requests to proxy is useful while running `@hishprorg/reiciendis-modi` on browser.
...
```js
import { extractFromJson } from '@hishprorg/reiciendis-modi'
...
```js
import { extractFromXml } from '@hishprorg/reiciendis-modi'
...
```bash
git clone https://github.com/hishprorg/reiciendis-modi.git
cd feed-extractor
pnpm i
pnpm test
```
